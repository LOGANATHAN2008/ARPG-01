...
import { CheckCircle2, Clock, MapPin, Mail, Building2, User, Calendar, FileText, CheckCircle, AlertCircle } from 'lucide-react'
...
export default function PublicInvoice() {
  ...
  return (
    <div className='min-h-screen bg-gray-50/50 flex flex-col items-center pt-8'>
